...
(function (SRNicoNico) {
    var Comment;
    (function (Comment) {
        var CommentEntry = /** @class */ (function () {
        ...
        var CommentViewModel = /** @class */ (function () {
            ...
            CommentViewModel.prototype.initialize = function () {
                //レイヤーを取得
            ...
            CommentViewModel.prototype.dispatchComment = function (jsonStr) {
                var _this = this;
                ...
                if (entry.Position == "naka") {
                    if (entry.Reverse) {
                        $(entry.Element).keyframes({
                            ...
                            duration: this.getDuration(entry, GetVideo().getVpos()),
                            easing: "linear",
                            count: 1 //ループされても困る
                        }, function () {
            ...
            CommentViewModel.prototype.getX = function (target, vpos) {
                //流れないコメントだったらX座標は一定
            ...
            CommentViewModel.prototype.getY = function (target) {
                var offsetY = 0;
            ...
            CommentViewModel.prototype.getDuration = function (target, vpos) {
                var offset = 1 - (vpos - target.Vpos) / (target.Vend - target.Vpos);
                return target.Duration * offset;
            };
            //コメント描画を一時停止
            CommentViewModel.prototype.pauseComment = function () {
                for (var _i = 0, _a = this.RenderingCommentList; _i < _a.length; _i++) {
                    var entry = _a[_i];
                    $(entry.Element).css("animation-play-state", "paused");
                }
            ...
            //コメント描画を再開
            CommentViewModel.prototype.resumeComment = function () {
                for (var _i = 0, _a = this.RenderingCommentList; _i < _a.length; _i++) {
                    var entry = _a[_i];
            ...
            //描画されているコメントを全て消す
            CommentViewModel.prototype.purgeComment = function () {
                this.RenderingCommentList.length = 0;
                $(this.Layer).empty();
            };
            //コメントレイヤーを表示
            CommentViewModel.prototype.showComment = function () {
                $(this.Layer).css("visibility", "visible");
            };
            //コメントレイヤーを非表示
            CommentViewModel.prototype.hideComment = function () {
                $(this.Layer).css("visibility", "hidden");
            };
            CommentViewModel.prototype.calcCommentSize = function (width, height) {
                var _this = this;
            ...
            //透明度を設定
            CommentViewModel.prototype.setOpacity = function (opacity) {
                for (var _i = 0, _a = this.RenderingCommentList; _i < _a.length; _i++) {
                    var entry = _a[_i];
            ...
            //コメントのデフォルトサイズを設定
            CommentViewModel.prototype.setBaseSize = function (str) {
                switch (str) {
                    case "極小":
        ...
        Comment.CommentViewModel = CommentViewModel;
        Comment.ViewModel = new CommentViewModel();
    })(Comment = SRNicoNico.Comment || (SRNicoNico.Comment = {}));
...
//# sourceMappingURL=commentlayer.js.map