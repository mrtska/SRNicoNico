...
function invoke_host(cmd:string, args:any = "") {
            ...
            if (entry.Reverse) {
                $(entry.Element).keyframes({
                    ...
                    "100%": {
                        ...
                        duration: this.getDuration(entry, VideoViewModel.getVpos()),  //コメント表示時間 普通は4秒
                        easing: "linear",
                        count: 1    //ループされても困る
                    }, () => {
...
let CommentViewModel = new CommentViewModelImpl();
