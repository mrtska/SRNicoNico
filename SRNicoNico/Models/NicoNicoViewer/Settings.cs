...
namespace SRNicoNico.Models.NicoNicoViewer {
    public class Settings : NotificationObject {
        ...
        public bool DisableJumpCommand {
            get { return _DisableJumpCommand; }
            set { 
                if(_DisableJumpCommand == value)
                    return;
                _DisableJumpCommand = value;
        ...
        private GridLength _SplitterHeight = new GridLength(300);

        public GridLength SplitterHeight {
            get { return _SplitterHeight; }
            set {
                if(_SplitterHeight.Value == value.Value)
                    return;
        ...
        #region UseResumePlay変更通知プロパティ
        private bool _UseResumePlay = false;

        public bool UseResumePlay {
            get { return _UseResumePlay; }
            set { 
                if(_UseResumePlay == value)
                    return;
                _UseResumePlay = value;
                RaisePropertyChanged();
                Save();
            }
        }
        ...
        #region RankingJikkyo変更通知プロパティ
        private bool _RankingJikkyo = true;

        public bool RankingJikkyo {
            get { return _RankingJikkyo; }
            set { 
                if(_RankingJikkyo == value)
                    return;
                _RankingJikkyo = value;
                RaisePropertyChanged();
                Save();
            }
        }
